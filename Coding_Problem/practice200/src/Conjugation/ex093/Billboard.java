...
public class Billboard implements Serializable {
	...
	public Billboard(int rank, String song, int lastweek, String imagesrc, String artis) {
		super();
		this.rank = rank;
		this.song = song;
		this.lastweek = lastweek;
	...
	public String toString() {
		return "[rank=" + rank + ", song=" + song  +", lastweek=" + lastweek + ", imagesrc="
				+ imagesrc + ", artis=" + artist + "]";
	}
